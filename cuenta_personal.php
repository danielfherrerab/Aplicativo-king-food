  ...
  <?php
	...
	<body background="imagenes/fondo-web.png" class="img">
        ...
        <li class="apartado"><a href="principal-proveedor.php"><img src="imagenes/logo2.png" alt="logotipo" class="logo-perfil"></a></li>
				...
				<li class="apartado"><button class="button type3" id="open"><a href="cuenta_personal.php? editar= <?php echo $id_usuario; ?>">Editar Informacion</a></button><br><br></li>
    ...
    <?php
        ...
        $conexion=mysqli_connect('localhost','root','','kingfood') or die ('problemas en la conexion');
				$borrar_carrito = mysqli_query($conexion,"DELETE FROM carrito WHERE id_usuarios = '$id_usuario'");
				$borrar_pedidos = mysqli_query($conexion,"DELETE FROM pedidos WHERE id_usuario = '$id_usuario'");
    ...
    <main>
			...
			<center><div class="informacion"><br><br><br>
				<table class="tabla-3" >
					<thead>
						<tr>
							<th class="text-left">Informacion Personal</th>
			...
			if(isset($_POST['actualizar_datos'])){
				...
				if ($ejecutar){
					echo "<script>
									...
									window.location.href ='cuenta_personal.php';
								</script> ";
