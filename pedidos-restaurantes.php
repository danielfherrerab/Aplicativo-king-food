					...
					<tbody>
						<?php
							while ($filas=mysqli_fetch_array($ejecutar)) {
								...
								$correo_entrega 		= $filas['correo_destino'];
								$numero_entrega 		= $filas['numero_destino'];
						?>

						<tr><form action="#" method="post">
							<td><?php echo $id_pedido;	      ?></td>
							<td><?php echo $correo_entrega;	      ?></td>
							<td><?php echo $numero_entrega;	      ?></td>
							<td><?php echo $numero_productos; ?></td>
							<td><?php echo $fecha_compra; ?></td>
              <td><b><?php echo $estado; ?></td>
            </form></tr>
