...
<head>
  ...
  <body background="imagenes/fondo-web.png" class="img">
		<nav class="barra-navegacion">
			<div class="contenedor-nav">
				...
				<ul class="links">
					...
					<li class="link"><a href="perfil-administrador.php" class="delineado">Mi perfil</a></li>
			...
			<div class="submenu">
				<a href="perfil-administrador.php"><?php echo "<img src='imagenes/$foto_usuario ?>' class='foto-perfil' alt=''  title='Mi perfil'>"; ?></a>
				<div id="info-perfil">
		...
		<div class="seccion-principal">
			<div class="seccion1">
				<p class="titulo">BIENVENIDO A KINGFOOD</p>
				<p>Los mejores productos los encontraras<br> en un solo lugar</p>
			</div>
					...
					<div class="rastreador" id="track">
						...
						<div class="secc-artic">
							<div class="articulos">
								...
								<p>$ 				<?php echo $precio ?></p>
								<button class="boton"><a href="principal-admin.php? agregar= <?php echo $id_producto; ?>">Agregar</a></button>
							</div>
			...
			<div class="carrusel-multi"><br>
				<div class="lista-multi" id="lista-multi">
					...
					<div class="rastreador" id="track">
						...
						<?php
							$observar = "SELECT * FROM productos where id_usuarios > 0  ORDER BY RAND() LIMIT 0,10";
							$ejecutar=mysqli_query($conexion,$observar);
							$contador = 0;
